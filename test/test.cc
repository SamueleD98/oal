  ...
  */
  ...
  switch (scenario) {
    ...
    case 2: {// head on WORKS (clear differences with/without Colregs)
      v_info.position = {10, 0};
      Obstacle obs1_1 = Obstacle("1", {10.5, 13}, -M_PI / 2, 0.5, -M_PI / 2, 2, 0.5, 3.2, 9, 3.2, 3);
...
//      obss_info.obstacles.push_back(std::make_shared<Obstacle>(obs1_1));
    ...
    case 3: {// TS crossing from right
      v_info.position = {10, 0};
      Obstacle obs3_1 = Obstacle("1", {24.4009, 10}, M_PI*6/7, 0.5, M_PI, 2, 0.5, 3.2, 9, 3.2, 3);
    ...
    case 8: {// start in bb
      v_info.position = {10, 0};
      Obstacle obs1_1 = Obstacle("1", {10, 2.5}, M_PI / 2, 3.12, M_PI / 2, 2, 1, 3.2, 4, 4, 1.1);
      Obstacle obs1_4 = Obstacle("1", {10, 2}, -M_PI / 2, 1, -M_PI / 2, 2, 1, 3.2, 4, 4, 1.1);
    ...
    case 9: {// goal in bb
      v_info.position = {10, 0};
      Obstacle obs1_1 = Obstacle("1", {10, 18}, M_PI / 2, 0, M_PI / 2, 2, 0.5, 3.2, 9, 3.2, 3, true);
    ...
    case 10: { // bb overlap
      v_info.position = {10, 0};
      Obstacle obs1 = Obstacle("1", {9, 3.7}, 0, 0, 0,1, 0.5, 2, 3, 3, 1);
      Obstacle obs2 = Obstacle("2", {11, 4}, 0, 0, 0,0.5, 0.5, 2, 3, 3, 1);
    ...
    case 11: { // goal surrounded
      v_info.position = {10, 0};
      Obstacle obs1_1 = Obstacle("1", {10, 9}, 0, 0, 0,2, 0.5, 2, 2, 2, 1);
      Obstacle obs1_2 = Obstacle("2", {10, 11}, 0, 0, 0,2, 0.5, 2, 2, 2, 1);
      Obstacle obs1_3 = Obstacle("3", {11, 10}, 0, 0, 0,2, 0.5, 2, 2, 2, 1);
      Obstacle obs1_4 = Obstacle("4", {9, 10}, 0, 0, 0,2, 0.5, 2, 2, 2, 1);
